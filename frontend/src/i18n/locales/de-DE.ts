export default {
  ...
  role: {
    ...
    deleteConfirm: 'Möchten Sie diese Rolle wirklich löschen?',
  },
  permission: {
    ...
    type: 'Typ',
    parent: 'Übergeordnet',
    deleteConfirm: 'Möchten Sie diese Berechtigung wirklich löschen?',
    types: {
      menu: 'Menü',
      button: 'Schaltfläche',
      api: 'API',
  ...
  validation: {
    ...
    password: 'Das Passwort muss zwischen 6 und 20 Zeichen lang sein',
    confirmPassword: 'Die Passwörter stimmen nicht überein',
    length: 'Die Länge muss zwischen {min} und {max} Zeichen liegen',
    roleCode: 'Der Rollencode darf nur Großbuchstaben und Unterstriche enthalten',
  },
  error: {
