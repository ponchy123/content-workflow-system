export default {
  ...
  role: {
    ...
    deleteConfirm: 'Voulez-vous vraiment supprimer ce rôle ?',
  },
  permission: {
    ...
    type: 'Type',
    parent: 'Parent',
    deleteConfirm: 'Voulez-vous vraiment supprimer cette permission ?',
    types: {
      menu: 'Menu',
      button: 'Bouton',
      api: 'API',
  ...
  validation: {
    ...
    password: 'Le mot de passe doit contenir entre 6 et 20 caractères',
    confirmPassword: 'Les mots de passe ne correspondent pas',
    length: 'La longueur doit être comprise entre {min} et {max} caractères',
    roleCode: 'Le code du rôle ne peut contenir que des lettres majuscules et des tirets bas',
  },
  error: {
    403: 'Accès refusé',
